...
if __name__ == '__main__':
    ...
    for CPD_alg in CPD_alg_set :
        ...
        # fit_alg = [
        #     "quant_reg", " pspline_iasls", "pspline_airpls",
        #     "modpoly", "goldindec", "penalized_poly",
        #     "imodpoly", "poly","fabc"
        # ]
    ...
    #alg set - structure folder - file - curve
        ...
        for single_alg_set in alg_sets:
            ...
            for folder_index in range( num_folders):
                ...
                for i in range(len(file_list)):
                    file_name,  baseline_mean, peak_mean, peak_index = alg_select(( file_list[i], data_baselines_folder[file_list[i]], data_CPD_folder[file_list[i]],single_alg_set ))
        ...
        save_filename = 'peak_info_result_50_'+ str(threshold) +'_'+ CPD_alg[0]   +'_' + CPD_alg[1] + '.json'
